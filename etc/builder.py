...
class PLC1_initialise(PmcSubstitution):

    def __init__(self, Controller, CMDS=""):
        self.__super.__init__(Controller = Controller, CMDS = CMDS)

    # __init__ arguments
    ArgInfo = makeArgInfo(__init__,
        Controller = Ident ('PMAC or GeoBrick', DeltaTau),
        CMDS       = Simple('Extra commands to run at startup', str))
...
class PLC6_servo_IC_setup(PmcSubstitution):
    ...
    TemplateFile = 'PLC6_servo_IC_setup.pmc'
    Arguments = ()
